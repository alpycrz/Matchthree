...
namespace Components
{
    public class Tile : MonoBehaviour, ICoordSet, IPoolObj
    {
        ...
        void ICoordSet.SetCoord(Vector2Int coord) => _coords = coord;

        public void Teleport(Vector3 worldPos) => _transform.position = worldPos;

        void ICoordSet.SetCoord(int x, int y) => _coords = new Vector2Int(x, y);
        
        public void AfterCreate(){}
        
        public void BeforeDeSpawn(){}
        
        public void TweenDelayedDeSpawn(Func<bool> onComplate){}
        ...
        public void DoMove(Vector3 worldPos) => _transform.DOMove(worldPos, 1f);
    }
