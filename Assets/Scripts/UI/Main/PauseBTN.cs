...
namespace UI.Main
{
    public class PauseBTN : UIBTN
    {
        ...
        protected override void OnClick()
        {
            ...
            Tween sizeIncTwn = _transform.DOScale(Vector3.one * 1.1f, 0.2f);
            sizeIncTwn.SetEase(Ease.OutElastic);

            Tween sizeDcrTwn = _transform.DOScale(Vector3.one * 1f, 0.2f);
            ...
            _clickSizeSeq.onComplete += delegate { MainUIEvents.PauseBTN?.Invoke();};
        }
    }
}